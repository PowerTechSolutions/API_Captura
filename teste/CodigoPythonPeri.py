...
try:
    ...
    cursor = conn.cursor()
    sql_querryDISCO = f'INSERT INTO Monitoramento_RAW (Uso,FKComponente_Monitorado) VALUES ({disco.percent},3)'
...
try:
    ...
    if mydb.is_connected():
        ...
        sql_querryDISCO = 'INSERT INTO Monitoramento_RAW (Uso,FKComponente_Monitorado) VALUES (%s,3)'
